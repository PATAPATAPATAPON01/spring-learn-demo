...
//        String text = "https://exhorizon.anlink.com/auto/login?accountId=4cb939c12ea84485a0cc16f1f314be72";
        String text = "http://localhost:8080/auto/login?accountId=4cb939c12ea84485a0cc16f1f314be72";
        //不含Logo
        //QRCodeUtil.encode(text, null, "e:\\", true);
        //含Logo，不指定二维码图片名
        //QRCodeUtil.encode(text, "e:\\csdn.jpg", "e:\\", true);
        //含Logo，指定二维码图片名
        QRCodeUtil.encode(text, "C:\\Users\\Public\\Pictures\\Sample Pictures/kaola.jpg", "D:\\", "qrcode", true);
    }
}